...
class showcheckup extends React.Component {
  constructor(props) {
    super(props);
    this.state={
                 ...
                 >
                   ...
                   <View  style={{ marginTop:50, marginHorizontal: 15,position: 'absolute'}}>
                     ...
                     <View style={{ flexDirection: "row",marginBottom: 20}}>
                       ...
                       <View center style={{ marginHorizontal: 20 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                           {this.props.Data["0"]["Checkups"][this.props.key]["weight"]}
                         </Text>
                       </View>
                     </View>
                     ...
                     <View style={{ flexDirection: "row" ,marginBottom: 20}}>
                       ...
                       <View center style={{ marginHorizontal: 20 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                           {this.props.Data["0"]["Checkups"][this.props.key]["urine"]}
                         </Text>
                       </View>
                     </View>
                     ...
                     <View style={{ flexDirection: "row" ,marginBottom: 20}}>
                       ...
                       <View center style={{ marginHorizontal: 29 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                           {this.props.Data["0"]["Checkups"][this.props.key]["TT"]}
                         </Text>
                       </View>
                     </View>
                     ...
                     <View style={{ flexDirection: "row",marginBottom: 20}}>
                       ...
                       <View center style={{ left: 31 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                           {this.props.Data["0"]["Checkups"][this.props.key]["IFA"]}
                         </Text>
                       </View>
                     </View>
                     ...
                     <View style={{ flexDirection: "row" ,marginBottom: 20}}>
                       ...
                       <View center style={{ marginHorizontal: 22 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                           {this.props.Data["0"]["Checkups"][this.props.key]["CVS"]}
                         </Text>
                       </View>
                     </View>
                     ...
                     <View style={{ flexDirection: "row" ,marginBottom: 20}}>
                       ...
                       <View center style={{ marginHorizontal: 26 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                          {this.props.Data["0"]["Checkups"][this.props.key]["FHS"]}
                         </Text>
                       </View>
                     </View>
                     ...
                     <View style={{ flexDirection: "row" ,marginBottom: 20}}>
                       ...
                       <View center style={{ marginHorizontal: 32 }}>
                         <Text black text50 style={{ fontWeight: "400" }}>
                           {this.props.Data["0"]["Checkups"][this.props.key]["HB%"]}
                         </Text>
                       </View>
                     </View>
...
export default connect(mapStateToProps)(showcheckup);
//export default showcheckup;
